...
/**
* $Id: myblocksadmin.php,v 1.9 2005/11/30 22:13:22 malanciault Exp $
* Module: FreeSection
...
function list_blocks()
{
	...
	// displaying TH
    freesection_collapsableBar('blockstable', 'blocksicon', _AM_FSECTION_BLOCKS, _AM_FSECTION_BLOCKSTXT);
	...
	freesection_close_collapsable('blockstable', 'blocksicon');
}
...
function list_groups()
{
    ...
    freesection_collapsableBar('groupstable', 'groupsicon', _AM_FSECTION_GROUPS, _AM_FSECTION_GROUPSINFO);
	$item_list = array() ;
	foreach( array_keys( $block_arr ) as $i ) {
	...
	echo $form->render() ;
    freesection_close_collapsable('groupstable', 'groupsicon');
}
...
freesection_adminMenu(4, _AM_FSECTION_BLOCKSANDGROUPS);
