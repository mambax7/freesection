...
/**
* $Id: mygrouppermform.php,v 1.6 2007/02/03 16:23:17 malanciault Exp $
* Module: FreeSection
...
//		$this->XoopsForm($title, 'groupperm_form', XOOPS_URL.'/modules/system/admin/groupperm.php', 'post'); GIJ
	...
	function render()
	{
		...
		// Hack by marcan : we don't need this title here, as it is managed by freesection_collapsable
		//$ret = '<h4>'.$this->getTitle().'</h4>'.$this->_permDesc.'<br />';
		$ret = '';
		// End of Hack by marcan : we don't need this title here, as it is managed by freesection_collapsable
