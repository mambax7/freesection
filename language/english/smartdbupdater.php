...
define("_SDU_NEEDUPDATE", "Your database is out-of-date. Please upgrade your database tables!<br><b>Note : The SmartFactory strongly recommends you to backup all FreeSection tables before running this upgrade script.</b><br>");
