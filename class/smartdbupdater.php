 ...
 * @version $Id: smartdbupdater.php,v 1.5 2007/02/03 16:23:18 malanciault Exp $
 ...
 */
global $xoopsConfig;
$common_file = XOOPS_ROOT_PATH . "/modules/freesection/language/" . $xoopsConfig['language'] . "/smartdbupdater.php";
if (!file_exists($common_file)) {

	$common_file = XOOPS_ROOT_PATH . "/modules/freesection/language/english/smartdbupdater.php";
}
