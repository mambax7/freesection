...
/**
* $Id: permission.php,v 1.9 2006/11/08 15:22:36 malanciault Exp $
* Module: FreeSection
...
class FreesectionPermissionHandler extends XoopsObjectHandler
{
	...
	*/
	...
	function getGrantedGroupsForIds($item_ids_array, $gperm_name=false) {
		...
		static $groups;
		static $freesection_all_permissions_fetched;
		...
		if ($gperm_name){
			...
			if ($freesection_all_permissions_fetched) {
				return $groups;
			} else {
				$freesection_all_permissions_fetched = true;
			}
		}
