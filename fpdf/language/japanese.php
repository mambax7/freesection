...
// ------------------------------------------------------------------------- //
require FSECTION_FPDF_PATH.'/japanese.php';
...
define('FSECTION_PDF_FORUM', 'Forum');
define('FSECTION_PDF_TOPIC', 'Topic');
define('FSECTION_PDF_SUBJECT', 'Subject');
define('FSECTION_PDF_AUTHOR', _POSTEDBY);
define('FSECTION_PDF_DATE', _MD_POSTEDON);
define('FSECTION_PDF_PAGE', 'Page %s');
