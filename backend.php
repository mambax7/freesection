...
/**
* $Id: backend.php,v 1.9 2006/08/21 13:30:28 malanciault Exp $
* Module: FreeSection
...
if (!$tpl->is_cached('db:freesection_rss.html')) {
	...
	$tpl->assign('channel_link', FREESECTION_URL);
	...
	$tpl->assign('channel_generator', 'FreeSection');
	...
	$sarray = $freesection_item_handler->getAllPublished(10,0,$categoryid);
	if (is_array($sarray)) {
...
$tpl->display('db:freesection_rss.html');
?>